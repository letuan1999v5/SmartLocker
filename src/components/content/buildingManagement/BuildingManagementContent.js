            ...
            <div style={borderStyle}>
                <div id="buildingManagementContent" style={contentStyle}>
                    <form onSubmit={handleSubmit(onSearchSubmit)}>
                        <div>
                            <input style={searchInputStyle} type={"text"} placeholder="Tòa nhà..." {...register("customerName")} />
                            <input style={searchInputStyle} type={"text"} placeholder="Địa chỉ..." {...register("customerName")} />
                    ...
                    <table class="styled-table" style={styledTable}>
                        <thead>
                            <tr>
                                ...
                                <th style={th1}>Địa chỉ</th>
                                <th style={th1}>Thông tin mô tả</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
