            ...
            <div style={borderStyle}>
                <div id="historyReportContent" style={contentStyle}>
                    <form onSubmit={handleSubmit(onSearchSubmit)}>
                        <div>
                            <input style={searchInputStyle} type={"text"} placeholder="Tên đăng nhập..." {...register("uName")} />
                            <input style={searchInputStyle} type={"text"} placeholder="Tên quản trị viên..." {...register("eName")} />
                            ...
                            <select id="rId" name="rId" style={selectStyle} {...register("rId")}>
                                <option value={0} hidden >Quyền hạn</option>
                                <option value={0} style={{ color: "gray" }} >Bất kỳ</option>
                    ...
                    <table class="styled-table" id="listToolTable" style={styledTable}>
                        <thead>
                            <tr>
                                <th style={th1}>Tên đăng nhập</th>
                                <th style={th1}>Họ và tên</th>
                                <th style={th1}>ID nhân sự</th>
                                <th style={th1}>Thẻ đang sử dụng</th>
                                <th style={th1}>Quyền hạn</th>
